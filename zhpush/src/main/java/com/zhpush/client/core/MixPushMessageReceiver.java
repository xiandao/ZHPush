...
public abstract class MixPushMessageReceiver extends BroadcastReceiver {
     ...
     * 收到透传消息
     */
    public static final String RECEIVE_THROUGH_MESSAGE = "com.zhpush.RECEIVE_THROUGH_MESSAGE";
    /**
     * 通知栏消息到达
     */
    public static final String NOTIFICATION_ARRIVED = "com.zhpush.NOTIFICATION_ARRIVED";
    /**
     * 通知栏消息被点击
     */
    public static final String NOTIFICATION_CLICKED = "com.zhpush.NOTIFICATION_CLICKED";
    /**
     * 出现异常
     */
    public static final String ERROR = "com.zhpush.ERROR";
